...
var
  frm_saidaest: Tfrm_saidaest;

implementation

uses u_module, u_menu, u_entrest;

{$R *.dfm}

procedure Tfrm_saidaest.FormActivate(Sender: TObject);
begin
  ComboBox1.Clear;
...
procedure Tfrm_saidaest.BitBtn2Click(Sender: TObject);
begin
  frm_saidaest.Close;
end;

procedure Tfrm_saidaest.BitBtn1Click(Sender: TObject);
...
begin
  ...
  // Grava historico de entradas
    ...
    begin
      ...
      SQL.Add('values ("'+frm_menu.Label2.Caption+'","'+ComboBox1.Text+'",'+edit1.Text+',CURRENT_DATE(),CURRENT_TIME(),"'+edit2.Text+'",'+inttostr(var_qtdatual)+',"SAIDA","");');
      ExecSQL;
    end;
